...
<body data-page="watchlist" data-user-id="<?php echo $currentUserId ?? 0; ?>" data-user-role="<?php echo htmlspecialchars($currentUserRole, ENT_QUOTES); ?>">
  <header class="main-header">
    ...
    <nav>
      ...
      <a href="watchlist.php" class="nav-link nav-watchlist active">
  ...
  <main class="content">
    ...
    <section class="cards-grid" id="watchlistGrid" aria-live="polite">
      <div class="grid-placeholder grid-placeholder-warning">Watchlist-ul tău este gol acum. Caută filme și adaugă-le aici pentru a le urmări mai târziu.</div>
    </section>
  </main>
  ...
  <!-- Modal Detalii Film (reutilizat ca pe homepage) -->
  ...
  <button class="back-to-top-btn" id="backToTopBtn" aria-label="Înapoi sus">
